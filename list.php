<div class="container">
<div class="well">
	<h3 align="left">Liste de sections</h3>
				...
				if($_SESSION['ACCOUNT_TYPE']=='Administrator'){
						echo '
				<div class="btn-group">
				  <a href="index.php?view=add" class="btn btn-default"><span class="glyphicon glyphicon-plus-sign"></span>  Nouveau </a>
				  <button type="submit" class="btn btn-default" name="delete"><span class="glyphicon glyphicon-trash"></span> Supprimer la sélection </button>
				</div>';
			}
			?>
				</form>
